...
# Keep this gate self-contained.  Public MiniJAM contract identity is checked
# by check_minijam_contract.sh; this gate only validates MiniCells-owned
# topology, ABI labels, and transport envelope.

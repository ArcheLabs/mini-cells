...
- [`06-native-clm/`](06-native-clm/): Native CLM v0 real-model workflows:
  ...
  - `native-clm-v0-m3l-query-sketch-gate-kaggle.ipynb` — checkpoint-only M3L mechanism diagnostic testing whether a compact historical query sketch plus current conflict queries can recover the learned lineage-local affine boundary without old-token/query replay in gate fitting.
